...
public interface ErrorCodeConstants {
    ...
    // ========== ExamAI 认证模块 1-002-000-000 ==========
    ErrorCode AUTH_CHANGE_PASSWORD_FAILED = new ErrorCode(1_002_000_002, "修改密码失败，旧密码不正确");
    ErrorCode AUTH_SEND_CODE_FAILED = new ErrorCode(1_002_000_003, "发送验证码失败");
    ErrorCode AUTH_RESET_PASSWORD_FAILED = new ErrorCode(1_002_000_006, "重置密码失败");
    ErrorCode AUTH_USERNAME_ALREADY_EXISTS = new ErrorCode(1_002_000_009, "用户名已被注册");
    ErrorCode AUTH_EMAIL_ALREADY_EXISTS = new ErrorCode(1_002_000_010, "邮箱已被使用");
    ErrorCode AUTH_USER_NOT_FOUND = new ErrorCode(1_002_000_011, "用户不存在");
    ErrorCode AUTH_CODE_INVALID = new ErrorCode(1_002_000_012, "验证码错误或已过期");
